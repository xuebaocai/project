...
DATASET_DIR = "E:/BaiduNetdiskDownload/models-master/models-master/mydata/data/"
DATASET_IMAGES_DIR = "{}/JPEGImages/".format(DATASET_DIR)
DATASET_ANNOTS_DIR = "{}/Annotations/".format(DATASET_DIR)

DATASET_AUGM_DIR = "E:/BaiduNetdiskDownload/models-master/models-master/mydata/data/"
DATASET_AUGM_IMAGES_DIR = "{}/JPEGImages_aug/".format(DATASET_AUGM_DIR)
DATASET_AUGM_ANNOTS_DIR = "{}/Annotations_aug/".format(DATASET_AUGM_DIR)
...
for image_path in images_path:
    ...
    for i in range(0, AUG_NB_AUGMENTATION_PER_IMAGE):
        ...
        aug_config = augmenters.SomeOf(
            (1, 4),
            [
                augmenters.Affine(scale=(0.8, 1.2)),
                augmenters.Affine(rotate=(-5, 5)),
                ...
                augmenters.Add((-5, 5), per_channel=0.5),
